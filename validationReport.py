...
""" % (msg, fn1, fn2, fn3, caption, label)
    ...
    def atomicModel(self, fnRoot, msg, caption, fnModel, label, bfactor=False, occupancy=False, rainbow=True):
        generateChimeraView(self.fnReportDir, fnModel, fnRoot + "1.jpg", False, 0, 0, 0, 0, bfactor=bfactor,
                            occupancy=occupancy, rainbow=rainbow)
