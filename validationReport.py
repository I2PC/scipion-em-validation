...
def generateChimeraView(fnWorkingDir, fnMap, fnView, isMap=True, threshold=0, angX=0, angY=0, angZ=0, bfactor=False,\
                        occupancy=False, rainbow=True, legendMin=None, legendMax=None):
    chimeraScript=\
"""
windowsize 1300 700
set bgColor white
...
""" % (msg, fn1, fn2, fn3, caption, label)
    ...
    def atomicModel(self, fnRoot, msg, caption, fnModel, label, bfactor=False, occupancy=False, rainbow=True, legendMin=None, legendMax=None):
        generateChimeraView(self.fnReportDir, fnModel, fnRoot + "1.jpg", False, 0, 0, 0, 0, bfactor=bfactor,
                            occupancy=occupancy, rainbow=rainbow, legendMin=legendMin, legendMax=legendMax)
