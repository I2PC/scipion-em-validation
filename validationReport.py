...
def generateChimeraView(fnWorkingDir, fnMap, fnView, isMap=True, threshold=0, angX=0, angY=0, angZ=0):
    chimeraScript=\
"""
set bgColor white
open %s
...
""" % (msg, fn1, fn2, fn3, caption, label)
    ...
    def atomicModel(self, fnRoot, msg, caption, fnModel, label):
        generateChimeraView(self.fnReportDir, fnModel, fnRoot + "1.jpg", False, 0, 0, 0, 0)
        generateChimeraView(self.fnReportDir, fnModel, fnRoot + "2.jpg", False, 0, 90, 0, 0)
        generateChimeraView(self.fnReportDir, fnModel, fnRoot + "3.jpg", False, 0, 0, 90, 0)
